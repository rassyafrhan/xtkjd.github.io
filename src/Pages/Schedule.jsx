...
const Schedule = () => {
    ...
    piketGroup = [
        ["Amanda", "Safira", "Radi", "Zaeni", "Rangga", "Nabil", "Ardi"],
        ["Yolanda", "Anisa", "Salasati", "Ihsan", "Julian", "Rafli", "Elvin"],
        ["Lola", "Malika", "Viana", "Bukhori", "Farhan", "Ilham"],
        ["Adit", "Yudis", "Tasya", "Rendara", "Teodor", "Sela" ,"Toni"],
        ["Alvin", "Karina", "Sudrajat", "Yana", "Zahran", "Rivan"],
    ]
